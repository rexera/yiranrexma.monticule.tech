...
export function QrCodeIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
      ...
      <path d="M14 14h3v3h-3zM21 14v3M17 21h4M14 21h3" />
    </SvgIcon>
  );
}

/* ── Brand marks (monochrome, filled) ─────────────────────────────
   Paths from simple-icons.org (X, GitHub, Instagram, WeChat,
   Xiaohongshu) and Font Awesome 6 (Douyin note, via Iconify). */

function BrandIcon({ title, children, ...props }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function DouyinIcon(props: IconProps) {
  return (
    <svg
      viewBox="0 0 448 512"
      fill="currentColor"
